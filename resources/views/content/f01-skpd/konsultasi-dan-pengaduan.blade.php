...
@section('title', 'Konsultasi dan Pengaduan')
...
@section('content')
    <h4 class="fw-bold py-3 mb-4">
        <span class="text-muted fw-light">F01-SKPD /</span> Konsultasi dan Pengaduan
    </h4>
    ...
    <div class="row">
        <div class="col-md-12">
            <ul class="nav nav-pills flex-column flex-md-row mb-4">
                ...
                <li class="nav-item"><a class="nav-link active" href="{{ url('konsultasi-dan-pengaduan') }}"><i
