...
@section('title', 'Pertanyaan Tambahan-V2')
...
@section('content')
    <h4 class="fw-bold py-3 mb-4">
        <span class="text-muted fw-light">F01-SKPD /</span> Pertanyaan Tambahan-V2
    </h4>
        ...
        <div class="col-md-12">
            <ul class="nav nav-pills flex-column flex-md-row mb-4">
                ...
                <li class="nav-item"><a class="nav-link" href="{{ url('inovasi-v2') }}"><i
                        ...
                        Inovasi</a></li>
                <li class="nav-item"><a class="nav-link active" href="{{ url('pertanyaan-tambahan-v2') }}"><i
                            class="ti-xs ti ti-link me-1"></i>
    ...
    <div class="col-12 d-flex justify-content-between">
        <button class="btn btn-danger btn-prev waves-effect">
            <a class="nav-link" href="{{ url('inovasi-v2') }}">Kembali</a>
        </button>
