...
@section('title', 'Sistem Informasi Pelayanan Publik-V2')
...
@section('content')
    <h4 class="fw-bold py-3 mb-4">
        <span class="text-muted fw-light">F01-SKPD /</span> Sistem Informasi Pelayanan Publik-V2
    </h4>
    ...
    <div class="row">
        <div class="col-md-12">
            <ul class="nav nav-pills flex-column flex-md-row mb-4">
                ...
                <li class="nav-item"><a class="nav-link active" href="{{ url('sistem-informasi-pelayanan-publik-v2') }}"><i
    ...
    <!-- Sistem Informasi Pelayanan Publik-v2 -->
    <div class="row my-4">
        <div class="col">
    ...
    <div class="col-12 d-flex justify-content-between">
        <button class="btn btn-danger btn-prev waves-effect">
            <a class="nav-link" href="{{ url('sarana-prasarana-v2') }}">Kembali</a>
        </button>
