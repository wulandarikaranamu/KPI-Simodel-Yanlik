...
@section('title', 'Kebijakan Pelayanan-V2')
...
@section('content')
    <h4 class="fw-bold py-3 mb-4">
        <span class="text-muted fw-light">F01-SKPD /</span> Kebijakan Pelayanan-V2
    </h4>

    <div class="row">
        <div class="col-md-12">
            <ul class="nav nav-pills flex-column flex-md-row mb-4">
                <li class="nav-item"><a class="nav-link active" href="{{ url('kebijakan-pelayanan-v2') }}"><i
            ...
            <div class="accordion" id="collapsibleSection">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col mt-2">
                                    <div class="form-check form-check-inline">
                                        <input name="1" class="form-check-input" type="radio" value=""
                                            id="1" checked disabled />
                                        <label class="form-check-label " for="collapsible-address-type-home"> ya
                                        </label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input name="2" class="form-check-input" type="radio" value=""
                                            id="2" disabled />
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-lg-2 col-md-10">
                                        <input class="form-control" type="number" value="10" id="html5-number-input "
                                            disabled>
                                    </div>
                                </div>
                                <div class="mb-3 row">
                                    <label class="form-check-label">Berapa jumlah jenis standar pelayanan yang
                                        dibuat</label>
                                    <div class="col-lg-2 col-md-10 ">
                                        <input class="form-control" type="number" value="15" id="html5-number-input "
                                            disabled>
                                    </div>
                                </div>
                                ...
                                <div class="col mt-2">
                                    <div class="form-check form-check-inline">
                                        <input name="3" class="form-check-input" type="radio" value="1"
                                            id="3" checked disabled />
                                        <label class="form-check-label active" for="collapsible-address-type-home"> ya
                                        </label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                ...
                                <div class="col mt-2">
                                    <div class="form-check form-check-inline">
                                        <input name="5" class="form-check-input" type="radio" value=""
                                            id="5" checked disabled />
                                        <label class="form-check-label" for="collapsible-address-type-home"> ya </label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input name="6" class="form-check-input" type="radio" value=""
                                            id="6" disabled />
                                        <label class="form-check-label" for="collapsible-address-type-office"> Tidak
                                        </label>
                                    </div>
                                ...
                                <div class="col mt-2">
                                    <div class="form-check form-check-inline">
                                        <input name="7" class="form-check-input" type="radio" value=""
                                            id="7" checked disabled />
                                        <label class="form-check-label" for="collapsible-address-type-home"> ya </label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input name="8" class="form-check-input" type="radio" value=""
                                            id="8" disabled />
                                        <label class="form-check-label" for="collapsible-address-type-office"> Tidak
                                        </label>
                                    </div>
                                ...
                                <div class="col mt-2">
                                    <div class="form-check form-check-inline">
                                        <input name="9" class="form-check-input" type="radio" value=""
                                            id="9" checked disabled />
                                        <label class="form-check-label" for="collapsible-address-type-home"> ya </label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input name="10" class="form-check-input" type="radio" value=""
                                            id="10" disabled />
                                        <label class="form-check-label" for="collapsible-address-type-office"> Tidak
                                        </label>
                                    </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <span class="form-control"><i class="ti ti-download ti-sm"></i><a href="">
                                            document.pdf</a> </span>
                    ...
                    <div id="collapsedua" class="accordion-collapse collapse show" data-bs-parent="#collapsibleSection">
                        <div class="accordion-body">
                            <div class="row g-3">
                                ...
                                <div class="col mt-2">
                                    <div class="form-check form-check-inline">
                                        <input name="11" class="form-check-input" type="radio" value=""
                                            id="11" checked disabled />
                                        <label class="form-check-label" for="collapsible-address-type-home"> ya </label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input name="12" class="form-check-input" type="radio" value=""
                                            id="12" disabled />
                                        <label class="form-check-label" for="collapsible-address-type-office"> Tidak
                                        </label>
                                    </div>
                                ...
                                <div class="col mt-2">
                                    <div class="form-check form-check-inline">
                                        <input name="collapsible-address-type" class="form-check-input" type="checkbox"
                                            value="" id="collapsible-address-type-home" checked="" disabled />
                    ...
                    <div id="collapsetiga" class="accordion-collapse collapse show" data-bs-parent="#collapsibleSection">
                        <div class="accordion-body">
                            <div class="row g-3">
                                ...
                                <div class="col mt-2">
                                    <div class="form-check form-check-inline">
                                        <input name="13" class="form-check-input" type="radio" value=""
                                            id="13" checked disabled />
                                        <label class="form-check-label" for="collapsible-address-type-home"> ya </label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input name="14" class="form-check-input" type="radio" value=""
                                            id="14" disabled />
                                        <label class="form-check-label" for="collapsible-address-type-office"> Tidak
                                        </label>
                                    </div>
                                ...
                                <div class="col mt-2">
                                    <div class="form-check form-check-inline">
                                        <input name="15" class="form-check-input" type="radio" value=""
                                            id="15" checked disabled />
                                        <label class="form-check-label" for="collapsible-address-type-home"> ya </label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input name="16" class="form-check-input" type="radio" value=""
                                            id="16" disabled />
                                        <label class="form-check-label" for="collapsible-address-type-office"> Tidak
                                        </label>
                                    </div>
                    ...
                    <div id="collapselima" class="accordion-collapse collapse show" data-bs-parent="#collapsibleSection">
                        <div class="accordion-body">
                            <div class="row g-3">
                                ...
                                <div class="col mt-2">
                                    <div class="form-check form-check-inline">
                                        <input name="17" class="form-check-input" type="radio" value=""
                                            id="17" checked disabled />
                                        <label class="form-check-label" for="collapsible-address-type-home"> ya </label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input name="18" class="form-check-input" type="radio" value=""
                                            id="18" disabled />
                                        <label class="form-check-label" for="collapsible-address-type-office"> Tidak
                                        </label>
                                    </div>
                    ...
                    <div id="collapseenam" class="accordion-collapse collapse show" data-bs-parent="#collapsibleSection">
                        <div class="accordion-body">
                            <div class="row g-3">
                                ...
                                <div></div>
                                <br>
                                <label class="form-check-label"> Apakah hasil SKM dilakukan tindak
                                    lanjut?</label>
                                <div class="col mt-2">
                                    <div class="form-check form-check-inline">
                                        <input name="collapsible-address-type" class="form-check-input" type="radio"
                                ...
                                <div class="col-md-6">
                                    <label class="form-label" for="collapsible-fullname">Dokumen atau Foto
                                        pelaksanaan
                                        SKM dan media yang
                                        digunakan (misalnya alat bantu SKM elektronik dan/atau kuesioner
                                        manual)</label>
                                    <span class="form-control"><i class="ti ti-download ti-sm"></i><a href="">
                                            document.pdf</a> </span>
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label" for="collapsible-fullname">Laporan hasil
                                        pelaksanaan
                                        SKM</label>
                                    <span class="form-control"><i class="ti ti-download ti-sm"></i><a href="">
                                            document.pdf</a> </span>
                ...
                <div class="card accordion-item">
                    ...
                    <div id="collapsetujuh" class="accordion-collapse collapse show"
                        ...
                        <div class="accordion-body">
                            <div class="row g-3">
                                <label class="form-check-label"> Sebutkan media publikasi hasil SKM (jawaban dapat
                                    lebih
                                    dari satu)</label>
                                <br>
                                <label class="form-check-label"> Media Publikasi</label>
                ...
                <div class="card accordion-item">
                    ...
                    <div id="collapsedelapan" class="accordion-collapse collapse show"
                        ...
                        <div class="accordion-body">
                            <div class="row g-3">
                                <label class="form-check-label"> Apakah sudah dibuat rencana tindak lanjut dari SKM
                                    yang
                                ...
                                <div></div>
                                <label class="form-check-label">Berapa persen rencana tindak lanjut yang
                                    direalisasikan
